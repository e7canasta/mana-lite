...
- [](std/mana-video/src/buffer_pool.rs)
- [](std/mana-video/src/decoder.rs)
- [](std/mana-video/src/format.rs)
- [](std/mana-video/src/raw.rs)
...
1. **Acquire**: The ingest thread takes a buffer from the pool [std/mana-video/src/buffer_pool.rs74-84](std/mana-video/src/buffer_pool.rs#L74-L84)
2. **Fill**: The decoder writes pixels into the buffer.
3. **Release**: Once the frame has been processed (inference and visualization complete), the buffer is returned to the pool via `release` [std/mana-video/src/buffer_pool.rs98-127](std/mana-video/src/buffer_pool.rs#L98-L127)

The pool is **bounded**. If the number of released buffers exceeds `max_bufs`, excess buffers are dropped to prevent memory leaks in error paths [std/mana-video/src/buffer_pool.rs120-123](std/mana-video/src/buffer_pool.rs#L120-L123)

**Sources:** [std/mana-video/src/buffer_pool.rs48-127](std/mana-video/src/buffer_pool.rs#L48-L127)
...
**Sources:** [src/snapshot.rs13-30](src/snapshot.rs#L13-L30) [std/mana-video/src/decoder.rs4-6](std/mana-video/src/decoder.rs#L4-L6) [std/mana-video/src/buffer_pool.rs48-59](std/mana-video/src/buffer_pool.rs#L48-L59)
