...
Represented by the compact corner-format box helpers in `mana-geometry/src/bbox.rs`.
...
flowchart TB
    ...
    subgraph CES["Code Entity Space (mana-geometry)"]
        StructBBox["BBox helpers (bbox.rs)"]
...
**Sources:** [std/mana-geometry/src/bbox.rs1-126](std/mana-geometry/src/bbox.rs#L1-L126) [std/mana-geometry/src/iou.rs7-18](std/mana-geometry/src/iou.rs#L7-L18)
